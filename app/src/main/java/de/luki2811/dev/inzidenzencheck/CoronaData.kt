...
class CoronaData(var context: Context, var activity: Activity) : Thread() {
    override fun run() {
        val urlLand: URL
        val urlBund: URL
        try {
    ...
    fun setAutoCompleteList() {
        var type = 0
        val radio_lk = activity.findViewById<RadioButton>(R.id.radioButton_landkreis)
        val radio_sk = activity.findViewById<RadioButton>(R.id.radioButton_stadtkreis)
        val radio_bl = activity.findViewById<RadioButton>(R.id.radioButton_bundesland)
